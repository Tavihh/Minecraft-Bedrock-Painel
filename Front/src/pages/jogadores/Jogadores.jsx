    ...
    return (
        <div>
            ...
            {jogadores.map(j => {
                ...
                const statusConfig = {
                    true: { cor: '#388e3c', texto: 'Jogando' },
                    false: { cor: '#f44336', texto: 'Offline' },

                };
                
                const currentStatus = statusConfig[j.esta_online] || { cor: '#757575', texto: 'Desconhecido' };
                
                return (
                <div className="list-item-player" key={j.id || j.gamertag} onClick={() => {render(<DetalheServidor id={j.id} container_id={j.container_id} render={render}/>,  `Painel`)}}>
                    
                    {/* 1. Nome e Ícone Principal */}
                    <div className="list-col-main">
                        <jg className="icon-player" xmlns="http://www.w3.org/2000/jg" height="24px" viewBox="0 -960 960 960" width="24px" fill={currentStatus.cor}>
                        ...
                        <div className="player-details">
                            <span className="player-title">{j.gamertag}</span>
                            <span className="player-subtext">{j.servidore.nome || 'Mundo Desconhecido'}</span>
                        </div>
                    </div>
                    ...
                    <div className="list-col-status">
                        <div className="status-badge" style={{ backgroundColor: `${currentStatus.cor}15`, color: currentStatus.cor }}>
                            <jg xmlns="http://www.w3.org/2000/jg" height="16px" viewBox="0 -960 960 960" width="16px" fill={currentStatus.cor}>
